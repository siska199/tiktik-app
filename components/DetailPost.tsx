...
const DetailPost : React.FC<Props> = ({setModalDetail, modalDetail}) => {
  ...
  return (
    <article className='fixed z-30 top-0 left-0 w-screen h-screen flex bg-black/50 sm:overflow-y-scroll'>
      ...
      <div className='m-auto bg-white w-full h-full sm:w-[80%] sm:h-[90%] sm:rounded-md flex flex-col sm:flex-row overflow-y-scroll'>
        ...
        <section className='bg-black sticky top-10 flex justify-center items-center sm:rounded-l-md '>
